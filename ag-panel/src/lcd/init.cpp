...
AbstractLCD *initLCD(AbstractBacklight *Backlight) {
  AbstractLCD *LCD = nullptr;
    ...
    LCD = new I2CPCF8574TextLCD(LCD_COLS, LCD_ROWS, LCD_I2C_ADDR);
  #elif defined(LCD_TEXT_I2C_RGB)
    LCD = new I2CRGBTextLCD(LCD_COLS, LCD_ROWS, 123, LCD_BACKLIGHT_COLOR);
  #elif defined(LCD_TEXT_I2C_AIP31068)
    LCD = new I2CAIP31068TextLCD(Backlight, LCD_COLS, LCD_ROWS, LCD_I2C_ADDR);
  #elif defined(LCD_TEXT_SPI_AIP31068)
    LCD = new SPIAIP31068TextLCD(Backlight, LCD_COLS, LCD_ROWS, LCD_PIN_SS, LCD_PIN_SCLK, LCD_PIN_MOSI, LCD_PIN_MISO);
  #else
